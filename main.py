...
# Forked and edited by hoemw
# Converted from Python2 to Python3 with 2to3 + Optimization via removing t.wait().
...
CHROME_DVR_DIR = '/bin/chromedriver'
...
def brutes(username, username_selector ,password_selector,login_btn_selector,pass_list, website):
    ...
    optionss.add_argument("--profile-directory=Default")
